        ...
        <div className='max-w-6xl mx-auto flex justify-center'>
            <div className='mt-5'>
                ...
                <form onSubmit={handelSubmit} className='flex flex-col justify-center gap-2 w-[250px] sm:w-[400px]'>
                    <input id='title' type='text' placeholder='Title..' onChange={handelChange} className='p-1 w-full sm:w-[400px] px-2 py-2 rounded-md bg-green-300' />
                    <textarea id='description' rows={5} type='text' placeholder='Desription..' onChange={handelChange} className='p-1 w-full sm:w-[400px] px-2 py-2 rounded-md bg-green-300' />
                    <div className='flex flex-col justify-center gap-2'>
                        <h1 className='text-sm'>Select An Image</h1>
                        ...
                        <img src={formData?.image} className='w-full h-24 ' />
                    </div>
